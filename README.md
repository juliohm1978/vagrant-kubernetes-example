...
This project presents a simple example of how Vagrant can be used to launch a small Kubernetes cluster. While minikube is a great, even faster alternative, this project should also give beginners the firest steps on how to setup a Kubernetes cluster on bare metal.
